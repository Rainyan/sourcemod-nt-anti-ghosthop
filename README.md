...
where v<sub>0</sub> = initial lateral velocity, Δv = velocity impulse (inverse of current overspeed), v<sub>f</sub> = final lateral velocity, clamped within max ghost carry speed.
